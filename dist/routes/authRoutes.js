 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/auth/signup', userController_1.signUp);
/**
 * @swagger
 * /api/auth/signin:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/auth/signin', userController_1.signIn);
/**
 * @swagger
 * /api/auth/refresh:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/auth/refresh', userController_1.refreshToken);
/**
 * @swagger
 * /api/auth/logout:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/auth/logout', auth_1.authenticateToken, userController_1.logout);
/**
 * @swagger
 * /api/auth/logout-all:
 *   post:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/auth/logout-all', auth_1.authenticateToken, userController_1.logoutAll);
/**
 * @swagger
 * /api/profile:
 *   get:
 ...
 *     description: Retrieve a list of all users (admin endpoint)
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
